...
export default {
  ...
  async addDefaultUpvoteEmoji(guild) {
    return await guild.emojis.create({
      attachment: "./src/configurator/emoji_upvote.png",
      name: "upvote",
    });
  },

  async addDefaultDownvoteEmoji(guild) {
    return await guild.emojis.create({
      attachment: "./src/configurator/emoji_downvote.png",
      name: "downvote",
    });
  },

  isValidEmoji(emoji, guildId) {
