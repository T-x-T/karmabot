...
export default function (redisIp, redisPort) {
  ...
  describe("disableUser", function () {
    ...
    it("throws when falsy userId is given", async function () {
      await assert.rejects(
        async () => await configurator.disableUser(null),
        new Error("No userId given")
      );
    });
  });
  ...
  describe("enableUser", function () {
    ...
    it("throws when falsy userId is given", async function () {
      await assert.rejects(
        async () => await configurator.enableUser(null),
        new Error("No userId given")
      );
    });
  });
  ...
  describe("disableGuildinUser", function () {
    ...
    it("adds guild to disabled list", async function () {
      ...
      let res = await redis.sismember(
        `${targetUserId}:config:disabledguilds`,
        guildId
      );
      assert.strictEqual(res, 1);
    });
    ...
    it("adds two guilds", async function () {
      ...
      let res2 = await redis.sismember(
        `${targetUserId}:config:disabledguilds`,
        guildId + 1
      );
      assert.strictEqual(res, 1);
    ...
    it("adds guild to correct user", async function () {
      ...
      let res = await redis.sismember(
        `${targetUserId + 1}:config:disabledguilds`,
        guildId + 1
      );
      assert.strictEqual(res, 1);
    });
    ...
    it("throws when falsy userId is given", async function () {
      await assert.rejects(
        async () => await configurator.disableGuildinUser(null, guildId),
        new Error("No userId given")
      );
    });
    ...
    it("throws when falsy guildId is given", async function () {
      await assert.rejects(
        async () => await configurator.disableGuildinUser(targetUserId, null),
        new Error("No guildId given")
      );
    });
  });
  ...
  describe("enableGuildInUser", function () {
    ...
    it("throws when falsy userId is given", async function () {
      await assert.rejects(
        async () => await configurator.enableGuildInUser(null, guildId),
        new Error("No userId given")
      );
    });
    ...
    it("throws when falsy guildId is given", async function () {
      await assert.rejects(
        async () => await configurator.enableGuildInUser(targetUserId, null),
        new Error("No guildId given")
      );
    });
  });
  ...
  describe("disableGuild", function () {
    ...
    it("throws when falsy guildId is given", async function () {
      await assert.rejects(
        async () => await configurator.disableGuild(null),
        new Error("No guildId given")
      );
    });
  });
  ...
  describe("enableGuild", function () {
    ...
    it("throws when falsy guildId is given", async function () {
      await assert.rejects(
        async () => await configurator.enableGuild(null),
        new Error("No guildId given")
      );
    });
  });
  ...
  describe("setUpvoteEmoji", function () {
    ...
    it("throws when falsy guildId is given", async function () {
      await assert.rejects(
        async () => await configurator.setUpvoteEmoji(null, upvoteEmojiId),
        new Error("No guildId given")
      );
    });
    ...
    it("throws when falsy upvoteEmojiId is given", async function () {
      await assert.rejects(
        async () => await configurator.setUpvoteEmoji(guildId, null),
        new Error("No emojiId given")
      );
    });
  });
  ...
  describe("setDownvoteEmoji", function () {
    ...
    it("throws when falsy guildId is given", async function () {
      await assert.rejects(
        async () => await configurator.setDownvoteEmoji(null, downvoteEmojiId),
        new Error("No guildId given")
      );
    });
    ...
    it("throws when falsy downvoteEmojiId is given", async function () {
      await assert.rejects(
        async () => await configurator.setDownvoteEmoji(guildId, null),
        new Error("No emojiId given")
      );
    });
  });
